function [endb,endNr,bstore,Nrstore,tstore] = serialdilMADAPT(Bt,Ct,s,P,m,p,plt,bo,errtype,K)

%Jaime Lopez 2017-09-28. Edits by Amir Erez.
...
if exist('bo', 'var') == 0 %Check if initial biomass ratio was specified
    b = zeros(m,1) + 1/m; %default to initial biomass ratio equal
else
    b = bo; %Specified initial biomass
end

if exist('errtype', 'var') == 0 %Check if errtype was specified
